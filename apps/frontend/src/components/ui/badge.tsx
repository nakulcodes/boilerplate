  ...
  'inline-flex items-center rounded-md border border-zinc-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-950 focus:ring-offset-2 dark:border-zinc-800 dark:focus:ring-zinc-300',
  {
    variants: {
      variant: {
        ...
        destructive:
          'border-transparent bg-red-500 text-zinc-50 shadow hover:bg-red-500/50  dark:bg-red-900 dark:text-zinc-50 dark:hover:bg-red-900/80',
        outline: 'text-zinc-950 dark:text-zinc-50',
        success:
          'bg-green-100 text-green-800 hover:bg-green-100/80 dark:bg-green-900 dark:text-zinc-50 dark:hover:bg-green-900/80',
      },
    },
    defaultVariants: {
      variant: 'default',
