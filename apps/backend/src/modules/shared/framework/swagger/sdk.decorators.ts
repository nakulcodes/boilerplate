...
export function SdkUsageExample(
  ...
  return applyDecorators(
    ApiExtension('x-speakeasy-usage-example', { title, description, position }),
  );
}
...
export function SdkMethodMaxParamsOverride(
  maxParamsBeforeCollapseToObject?: number,
) {
  return applyDecorators(
    ApiExtension(
      'x-speakeasy-max-method-params',
      maxParamsBeforeCollapseToObject,
    ),
  );
}
...
export function SdkApiParam(
  ...
  sdkOverrideOptions?: SDKOverrideOptions,
) {
